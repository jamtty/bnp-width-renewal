...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    sub: [
      ...
      { label: '공황·불안 상담', to: '/specialized/features?tab=panic' },
      { label: '번아웃·직장 스트레스 상담', to: '/specialized/features?tab=burnout' },
      { label: 'ADHD·실행력 상담', to: '/specialized/features?tab=adhd' },
      { label: '은둔 · 고립 청년 상담', to: '/specialized/features?tab=recluse' },
      { label: '중독 회복 상담', to: '/specialized/features?tab=addiction' },
      { label: '식이장애·섭식문제 상담', to: '/specialized/features?tab=eating' },
      { label: '커리어 전환·방향 설계 상담', to: '/specialized/features?tab=career' },
    ],
  },
  {
    id: 'psychology',
  ...
  },
  {
    ...
    sub: [
      ...
      { label: '선교사 심리상담', to: '/global/features?tab=missionary' },
      { label: '다문화·유학생 심리상담', to: '/global/features?tab=multicultural' },
      { label: '해외 거주자 상담', to: '/global/features?tab=overseas' },
      { label: '귀국자 상담', to: '/global/features?tab=returnee' },
      { label: 'Global Business (B2B)', to: '/global/features?tab=b2b' },
  ...
  },
  {
    ...
    sub: [
      ...
      { label: '교회·사역자 교육 프로그램', to: '/academy/church' },
      { label: '기관·기업 교육 프로그램', to: '/academy/corporate' },
