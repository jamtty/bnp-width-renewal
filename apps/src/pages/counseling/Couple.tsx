                    ...
                    <>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>현재의 관계를 이해하고, 함께 살아가기 위한 건강한 관계의 기초를 만들어 갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>기질·성격 검사 (TCI)</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                <h3>부부 관계 진단 패키지</h3>
                                <p>반복되는 갈등의 이유를 개인의 문제가 아닌 관계의 구조와 패턴을 통해 이해합니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>관계 만족도 검사</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>중요한 결정을 내리기 전, 감정에만 휩쓸리지 않고 현재의 관계를 객관적으로 점검합니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>관계 만족도 평가</li>
                                ...
                                <p>현재 관계 상태 · 핵심 갈등 · 관계 변화 가능성 탐색</p>
                            </div>
                        ...
                        */}
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>관계 속에서 멀어진 친밀감과 정서적 연결을 회복하고,다시 함께 살아갈 관계의 방식을 만들어갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>감정적 연결 회복</li>
                    ...
                    <>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>좋아하는 마음만으로 건강한 관계가 만들어지는 것은 아닙니다.<br />서로의 감정과 애착 방식을 이해하고 건강하게 사랑하는 방법을 배워갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>애착 이해</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>사랑을 넘어 함께 살아가기 위해 서로의 가치관과 기대, 성격과 관계 방식을 이해하고 결혼생활의 기초를 준비합니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>성격 이해</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                <h3>왜 우리는 같은 문제로<span className='pc_br'></span>싸울까?<br />(부부 갈등 상담)</h3>
                                <p>누가 옳고 그른지를 따지기보다 반복되는 갈등 속에 숨은 감정과 욕구, 관계 패턴을 이해하고 새로운 소통 방식을 만들어갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>갈등 패턴 이해</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                <h3>가까워질 용기<br />(부부관계 재설계 상담)</h3>
                                <p>관계 속에서 멀어진 친밀감과 정서적 연결을 회복하고, 서로를 새롭게 이해하며 다시 함께 살아갈 관계의 방식을 만들어갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>정서적 연결 회복</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                <h3>외도·신뢰 회복 상담</h3>
                                <p>외도나 관계의 배신으로 무너진 신뢰와 상처를 다루고, 관계를 지속할 것인지에 대한 선택과 회복의 과정을 함께합니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>상처와 감정 정리</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                <h3>이별 후 관계 상담</h3>
                                <p>헤어진 관계와 이별의 이유를 객관적으로 돌아보고, 다시 만나는 것이 서로에게 건강한 선택인지 함께 살펴봅니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>감정 정리</li>
                        ...
                        <AnimatedSection className="box" direction="up">
                            <div className='s_tit'>
                                ...
                                <p>관계를 유지해야 할지 끝내야 할지 혼란스러운 상황에서 현재의 관계를 객관적으로 이해하고, 충분히 고민한 후 자신에게 중요한 선택의 방향을 찾아갑니다.</p>
                            </div>
                            <div className='s_info'>
                                <ul className='ul_list_1'>
                                    <li>관계 상태 점검</li>
