            ...
            */}
            <AnimatedSection className="box d-block-new" direction="up">
                <div className='s_tit d-flex'>
                    <h3>진행과정</h3>
                    <p>아동의 연령과 발달 수준, 평가 내용에 따라 소요 시간과 검사 구성이 달라질 수 있습니다.  이것을 추가 해 주세요</p>
                </div>
                <div className='s_info'>
            ...
            <AnimatedSection className="btn_wrap" direction="up">
                <a href="http://pf.kakao.com/_AXwJn/chat" target="_blank" rel="noopener noreferrer" className='btn_primary'>아동 심리검사 예약하기</a>
            </AnimatedSection>
        </section>
    </div>
  );
